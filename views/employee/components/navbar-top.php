<nav class="sb-topnav navbar navbar-expand navbar-dark text-white bg-success">
    <!-- Navbar Brand-->
    ...
    <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4 ">
        <li class="nav-item dropdown pe-3">
            ...
            <div class="dropdown-menu dropdown-menu-end shadow animated" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="/employee/activity-log">
                    <i class="fas fa-list fa-sm fa-fw mr-2 text-gray-400"></i>
                    Activity Log
                </a>
                <div class="dropdown-divider"></div>
                <!-- Logout -->
                <form action="/employee/logout" name="logout_form" method="post" style="margin: 0;">
